...
namespace CSharpPOCOModel
{
    public class CRichTextBoxMenu
    {
        ...
        private ToolStripMenuItem CMcopy = new ToolStripMenuItem("¸´ÖÆ");

        private ToolStripMenuItem CMcut = new ToolStripMenuItem("¼ôÌù");

        private ToolStripMenuItem CMdel = new ToolStripMenuItem("É¾³ý");

        private ToolStripMenuItem CMcancle = new ToolStripMenuItem("³·Ïú");

        private ToolStripMenuItem CMpaste = new ToolStripMenuItem("Õ³Ìù");

        private ToolStripMenuItem CMselectall = new ToolStripMenuItem("È«Ñ¡");

        private ToolStripMenuItem CMalign = new ToolStripMenuItem("ÓÒ¶ÔÆë");
